...
public class JavaBankATMV4 {
    ...
    public static void main(String[] args) {
        ...
        sifreListesi.add(1111);
        sifreListesi.add(2222);
        sifreListesi.add(3333);
        sifreListesi.add(4444);
...
//*************************
        ...
        System.out.print("60 Kart Numaranızı giriniz : ");
        kartnu = scan.nextLine();
        kartnu = kartnu.trim();  //başından ve sonundan boşluklar alındı
        kartnu = kartnu.replace(" ", ""); // arasındaki boşluklar alındı

        System.out.println(" 66 KartNumaralarListesi = " + KartNumaralarListesi);
        for (int i = 0; i < KartNumaralarListesi.size(); i++) {
            System.out.println("68 KartNumaralarListesi = " + KartNumaralarListesi.get(i));
            if ((KartNumaralarListesi.contains(kartnu))) {
                System.out.println("69 doğru " + KartNumaralarListesi.get(i));
                break;
            } else if ((KartNumaralarListesi.get(i).contains(kartnu))){
                System.out.println(" DUR ");
                System.out.println(" 72 KartNumaralarListesi = " + KartNumaralarListesi);break;
        ...
        while (true) {
            ...
            if (sifreListesi.contains(girilenSifre)) {
                ...
                System.out.println("Şifere veya Kart numaranız Yanlış. \n Lütfen Banka şubeniz ile görüşün :)");
                break;
        ...
        while (true) {
          ...
          islemSecme = scan.nextInt();
            ...
            {
               System.out.println(yapilacaklarListesi);
               System.out.println("208 Lütfen yapmak istediğiniz işlemin başındaki sayıyı giriniz: ");
               islemSecme = scan.nextInt();
            }
            ////////*********** Çıkış *************
            if (islemSecme == 6) {
