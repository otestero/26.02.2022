...
//*************************
        ...
        while (true) {
            ...
            if (KartNumaralarListesi.contains(kartnu) || sifreListesi.contains(girilenSifre) ) {
                break;
            }
            ...
            if (girisHakki == 0) {
                System.out.println(" Hakkınız kalmadi. Şubenizle görüşün: ");
         ...
         /*  while (true) {
           ...
           System.out.println(yapilacaklarListesi);
            ...
            while (true) {
                ...
                //System.out.println(yapilacaklarListesi);
                //System.out.println("181 Lütfen yapmak istediğiniz işlemin başındaki sayıyı giriniz: ");
                // islemSecme = scan.nextInt();
